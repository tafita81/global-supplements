  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      <div className="bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border/50">
        ...
        {/* Categories Navigation Bar - Single Row */}
        <div className="border-t border-border/30 bg-gradient-to-r from-gray-100 to-gray-200/90 shadow-sm">
          <div className="max-w-full mx-auto px-2 sm:px-4 lg:px-6">
            <div className="flex items-center justify-between py-2 w-full">
              {/* Home Button */}
              <button
                onClick={() => navigate("/public-site")}
                className="text-sm font-semibold text-gray-700 hover:text-primary transition-all duration-200 px-4 py-2 hover:bg-white/80 hover:shadow-md rounded-lg flex items-center gap-2 border border-transparent hover:border-primary/20 whitespace-nowrap bg-white/50"
              >
              ...
              {navigationCategories.map((category, index) => (
                <button
                  ...
                  className="text-sm font-medium text-gray-700 hover:text-primary transition-all duration-200 px-3 py-2 hover:bg-white/90 hover:shadow-md rounded-lg border border-transparent hover:border-primary/20 text-center whitespace-nowrap bg-white/30 hover:bg-white/80"
                >
